...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* nMNSC features */
        {"nmnsc", "listmasternodes", &listmasternodes, true },
        {"nmnsc", "getmasternodecount", &getmasternodecount, true },
        {"nmnsc", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"nmnsc", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"nmnsc", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"nmnsc", "masternodecurrent", &masternodecurrent, true },
        {"nmnsc", "startmasternode", &startmasternode, true },
        {"nmnsc", "reloadmasternodeconfig", &reloadmasternodeconfig, true },
        {"nmnsc", "createmasternodekey", &createmasternodekey, true },
        {"nmnsc", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"nmnsc", "listmasternodeconf", &listmasternodeconf, true },
        {"nmnsc", "getactivemasternodecount", &getactivemasternodecount, true },
        {"nmnsc", "getmasternodestatus", &getmasternodestatus, true },
        {"nmnsc", "getmasternodewinners", &getmasternodewinners, true },
        {"nmnsc", "getmasternodescores", &getmasternodescores, true },
        {"nmnsc", "mnsync", &mnsync, true },
        {"nmnsc", "spork", &spork, true },
        {"nmnsc", "mnping", &mnping, true },
...
{
    return "> nmnsc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:14259/\n";
}
