...
/* nMNSC GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "nmnsc"
#define QAPP_ORG_DOMAIN "nmnsc.org"
#define QAPP_APP_NAME_DEFAULT "nmnsc-Qt"
#define QAPP_APP_NAME_TESTNET "nmnsc-Qt-testnet"
