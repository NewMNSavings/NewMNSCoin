...
/** Utility functions used by the nMNSC Qt UI.
 */
namespace GUIUtil
{
...
// Render nMNSC addresses in monospace font
...
// Parse "nmnsc:" URI into recipient object, return true on successful parsing
