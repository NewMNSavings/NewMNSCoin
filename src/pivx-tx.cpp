...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("nMNSC nmnsc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nmnsc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nmnsc transaction") + "\n" +
                               "  nmnsc-tx [options] -create [commands]   " + _("Create hex-encoded nmnsc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nmnsc transaction
