...
# Clone code from official Github repository
    rm -rf NewMNCoin
    git clone https://github.com/NewMNSavings/NewMNSCoin.git
...
# Create zip file of binaries
    cp NewMNCoin/src/nmnscd NewMNCoin/src/nmnsc-cli NewMNCoin/src/nmnsc-tx NewMNCoin/src/qt/nmnsc-qt NewMNCoin/nMNSC-Core.dmg .
    zip NewMNCoin-MacOS.zip nmnscd nmnsc-cli nmnsc-tx nmnsc-qt nMNSC-Core.dmg
    rm -f nmnscd nmnsc-cli nmnsc-tx nmnsc-qt nMNSC-Core.dmg
