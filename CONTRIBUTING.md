Contributing to nMNSC Core
============================

The nMNSC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the nMNSC Core project, and is not to be
confused with overall nMNSC Network Protocol consensus changes.

Whether a pull request is merged into nMNSC Core rests with the project merge
...
Patches that change nMNSC consensus rules are considerably more involved than
...
Where a patchset proposes to change the nMNSC consensus, it must have been
...
The project leader is the release manager for each nMNSC Core release.
