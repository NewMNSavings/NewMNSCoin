...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='nmnsc.conf'
CONFIGFOLDER='/root/.nmnsc'
COIN_DAEMON='nmnscd'
COIN_CLI='nmnsc-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/NewMNSavings/NewMNSCoin/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
