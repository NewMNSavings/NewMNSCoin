...
* Fill in the following data:
    * Application Name: `nMNSC Core`
    * Application Version: `1.2.0.0`
    * Application Publisher: `2023 NewMNSCoin Core Developers`
    * Application Website: `https://nmnsc.com/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `nmnsc`
* Add application files:
    * Select the file `nmnsc-pt.exe` as main executable from the `package` folder
