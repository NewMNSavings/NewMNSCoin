...
#define MyAppName "nMNSC Core"
#define MyAppPublisher "2023 NewMNSavings Coin Core Developers"
#define MyAppURL "https://nmnsc.com"
#define MyAppExeName "nmnsc-qt.exe"
#define MyAppExtraData "https://github.com/NewMNSavings/NewMNSCoin/releases/download/NewMNSC-Wallet-v1.0.0.0/bootstrap.zip"
...
AppId={{92bc7580-ebcf-4b51-a95d-9f2a3dddc1e9}
AppName={#MyAppName}
...
[Files]
Source: ".\package\nmnsc-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\nMNSC\nMNSC-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\nMNSC\nMNSC-Qt,strDataDir|{userappdata}\nMNSC\}');
  Result := True;
end;
