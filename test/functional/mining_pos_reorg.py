...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected nMNSC supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check nMNSC supply at the beginning
        # ------------------------------------------
        # nMNSC supply: block rewards minus burned fees for minting
        ...
        # Verify that nMNSC supplies were properly updated after the spends and reorgs
        self.log.info("Check nMNSC supply...")
