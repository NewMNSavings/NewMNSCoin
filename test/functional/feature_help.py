...
"""Verify that starting nmnsc with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nmnsc with -? for help text")
        ...
        self.log.info("Start nmnsc with -version for version information")
