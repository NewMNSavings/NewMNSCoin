...
# Create zip file of binaries
	cp NewMNCoin/src/nmnscd NewMNCoin/src/nmnsc-cli NewMNCoin/src/nmnsc-tx NewMNCoin/src/qt/nmnsc-qt .
	zip NewMNCoin-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip nmnscd nmnsc-cli nmnsc-tx nmnsc-qt
	rm -f nmnscd nmnsc-cli nmnsc-tx nmnsc-qt
